...
class ThoughttreeMenu(Menu):
    ...
    def create_menu(self):
        ...
        menu = Menu(self, "Chat")
        item("Send Chat Message", "<Control-Return>", lambda e: self.tt.chat(1, "\n\n", "\n\n"))
        item("Continue Alternative", "<Alt-Return>", lambda e: self.tt.chat(-1, "\n"))
        item("Complete Directly", "<Shift-Return>", lambda e: self.tt.chat())
        menu.add_separator()
        item("Complete 2 Times", "<Control-Key-2>", lambda e: self.tt.chat(2))
        item("Complete 3 Times", "<Control-Key-3>", lambda e: self.tt.chat(3))
        item("Complete 5 Times", "<Control-Key-5>", lambda e: self.tt.chat(5))
        item("Complete Multiple...", "<Control-Shift-M>", lambda e: self.tt.chat(0))
        item("Complete Multiple Again", "<Control-m>", lambda e: self.tt.chat(-1))
