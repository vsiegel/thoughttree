...
if __name__ == "__main__":
    for menu_item, help_text in menu_help.items():
        print(f'    "{menu_item}": ', end="")
        if menu_item in menu_command_help_refined or menu_item in menu_command_help_refined_again:
            if menu_item in menu_command_help_refined:
                help_text = menu_command_help_refined[menu_item]
            if menu_item in menu_command_help_refined_again:
                help_text = menu_command_help_refined_again[menu_item]
