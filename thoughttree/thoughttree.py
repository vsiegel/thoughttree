...
class Thoughttree:
    ...
    def create_menu(self):
        ...
        item("Send Chat Message", "<Control-Return>", lambda e: self.chat_continue("\n"))
        ...
        menu.add_separator()
        item("Complete 2 Times", "<Control-Key-2>", lambda e: self.chat_continue("", "", 2))
        item("Complete 3 Times", "<Control-Key-3>", lambda e: self.chat_continue("", "", 3))
        item("Complete 5 Times", "<Control-Key-5>", lambda e: self.chat_continue("", "", 5))
