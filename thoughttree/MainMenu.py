...
class MainMenu(MenuBar):
    ...
    def create_menu(self):
        ...
        navigate.item("Next Message", "<Tab>", lambda e=None: e.widget.tk_focusNext())
        navigate.item("Previous Message", "<Shift-Tab>", lambda e=None: e.widget.tk_focusPrev())
        navigate.item("Next Tab", "<Control-Tab>", None)
        navigate.item("Previous Tab", "<Control-Shift-Tab>", None)
        navigate.separator()
