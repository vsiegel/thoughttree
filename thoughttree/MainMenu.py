...
class MainMenu(Menu):
    ...
    def create_menu(self):
        ...
        item("Insert", "<Control-Shift-space>", lambda e=None: ui.chat(inline=True, here=True))
        item("Replace", "<Control-Alt-space>", lambda e=None: ui.chat(inline=True, replace=True))
